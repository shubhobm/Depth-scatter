...
Tables \ref{table:FSEtable2}, \ref{table:FSEtable3} and \ref{table:FSEtable5} give FSE values for $p=2,3,5$, respectively.
...
\begin{footnotesize}
   \begin{tabular}{l|lllll|lll}
    ...
    $n$=20                 & 0.81 & 0.82  & 0.95   & 0.95   & 0.86  & 1.01    & 0.96    & 0.89   \\
    $n$=50                 & 0.83 & 0.87  & 1.34   & 1.30   & 1.27  & 1.41    & 1.31    & 1.33   \\
    $n$=100                & 1.16 & 1.17  & 1.73   & 1.34   & 1.64  & 1.84    & 1.41    & 1.68   \\
    $n$=300                & 1.17 & 1.23  & 1.76   & 1.45   & 1.76  & 1.88    & 1.49    & 1.87   \\ \hline
    $F$ = Bivariate $t_6$  & SCM  & Tyler & HSD-CM & MhD-CM & PD-CM & HSD-wCM & MhD-wCM & PD-wCM \\ \hline
    $n$=20                 & 0.73 & 0.79  & 0.92   & 0.94   & 0.90  & 0.98    & 0.98    & 0.92   \\
    $n$=50                 & 0.76 & 0.84  & 1.15   & 1.01   & 1.05  & 1.20    & 1.03    & 1.09   \\
    $n$=100                & 0.86 & 0.89  & 1.31   & 1.14   & 1.37  & 1.39    & 1.19    & 1.46   \\
    $n$=300                & 0.86 & 0.95  & 1.41   & 1.28   & 1.39  & 1.52    & 1.35    & 1.47   \\ \hline
    $F$ = Bivariate $t_{10}$ & SCM  & Tyler & HSD-CM & MhD-CM & PD-CM & HSD-wCM & MhD-wCM & PD-wCM \\ \hline
    $n$=20                 & 0.74 & 0.77  & 0.86   & 0.83   & 0.81  & 0.90    & 0.85    & 0.82   \\
    $n$=50                 & 0.62 & 0.69  & 0.86   & 0.81   & 0.87  & 0.88    & 0.84    & 0.93   \\
    $n$=100                & 0.48 & 0.52  & 0.83   & 0.72   & 0.87  & 0.86    & 0.74    & 0.93   \\
    $n$=300                & 0.60 & 0.61  & 0.92   & 0.86   & 1.02  & 0.96    & 0.89    & 1.06   \\ \hline
