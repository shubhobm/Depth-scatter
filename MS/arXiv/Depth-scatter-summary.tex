...
\Sigma_T = E \left[ \frac{(\bfx - \bfmu) (\bfx - \bfmu)^T}{(\bfx - \bfmu)^T \Sigma_T^{-1} (\bfx - \bfmu)} \right]
\end{equation}
...
\begin{figure}[t]
	\centering
		\includegraphics[height=6cm]{octane_screeplot.png}
	\caption{Explained variance proportions for two types of PCA on octane data}
	\label{fig:screeplot}
\end{figure}
\begin{figure}[h]
	\centering
		\includegraphics[height=6.5cm]{octane_distplot.png}
